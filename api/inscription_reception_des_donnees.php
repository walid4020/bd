<?php
    ...
    $stmt = $connexion->prepare("SELECT id FROM users WHERE email_address = :email");
        // requête SQL : sélectionne l'id depuis la table users où l'email_address est égal à l'email fourni
    ...
    ");
        /* requête SQL : Insère une nouvelle ligne dans la table users en remplissant les colonnes first_name, last_name, 
        birth_date, phone_number, country, email_address et password_hash avec les valeurs fournies */ 
    $stmt->execute([
